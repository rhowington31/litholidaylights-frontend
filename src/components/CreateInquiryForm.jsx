...
export default function CreateInquiryForm() {
  const handleCreateInquiry = (event) => {
    ...
    console.log(createInquiryParams);
    axios.post("http://localhost:3000/inquiries", createInquiryParams);
  };

  return (
    <form action="/inquiries" method="post" onSubmit={handleCreateInquiry} className="pl-50">
